...
public class ServiceUnitTests {
    ...
    static RegisterResult register() throws DataAccessException {
    ...
    @Test
    void negativeRegisterTwice() throws DataAccessException {
        register();
    ...
    @Test
    void negativeLoginInvalid() throws DataAccessException {
        var request = new LoginRequest("TestUser", "pass");
        User userService = new User(uDAO, aDAO);
    ...
    @Test
    void positiveNewGame() throws DataAccessException {
        var registerResult = register();
    ...
    @Test
    void negativeNewGame() throws DataAccessException {
        var registerResult = register();
        Game gameService = new Game(aDAO, gDAO);
    ...
    @Test
    void positiveJoinResult() throws BadRequestResponse, DataAccessException {
        var registerResult = register();
        Game gameService = new Game(aDAO, gDAO);
        CreateRequest request = new CreateRequest("testGame");
        gameService.newGame(registerResult.authToken(), request);
    ...
    @Test
    void negativeJoinResult() throws DataAccessException {
        var registerResult = register();
        Game gameService = new Game(aDAO, gDAO);
        CreateRequest request = new CreateRequest("testGame");
        gameService.newGame(registerResult.authToken(), request);
